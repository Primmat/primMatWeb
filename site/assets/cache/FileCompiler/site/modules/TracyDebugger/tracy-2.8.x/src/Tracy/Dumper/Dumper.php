...
class Dumper
{
	...
	public static function renderAssets(): void
	{
		...
		$s = file_get_contents('/Users/joseffajkus/Desktop/primmatWebProcesswire/site/modules/TracyDebugger/tracy-2.8.x/src/Tracy/Dumper' . '/../Toggle/toggle.css')
			. file_get_contents('/Users/joseffajkus/Desktop/primmatWebProcesswire/site/modules/TracyDebugger/tracy-2.8.x/src/Tracy/Dumper' . '/assets/dumper-light.css')
			. file_get_contents('/Users/joseffajkus/Desktop/primmatWebProcesswire/site/modules/TracyDebugger/tracy-2.8.x/src/Tracy/Dumper' . '/assets/dumper-dark.css');
		echo "<style{$nonceAttr}>", str_replace('</', '<\/', Helpers::minifyCss($s)), "</style>\n";

		if (!Debugger::isEnabled()) {
			$s = '(function(){' . file_get_contents('/Users/joseffajkus/Desktop/primmatWebProcesswire/site/modules/TracyDebugger/tracy-2.8.x/src/Tracy/Dumper' . '/../Toggle/toggle.js') . '})();'
				. '(function(){' . file_get_contents('/Users/joseffajkus/Desktop/primmatWebProcesswire/site/modules/TracyDebugger/tracy-2.8.x/src/Tracy/Dumper' . '/../Dumper/assets/dumper.js') . '})();';
